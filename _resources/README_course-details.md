...
- Course duration: Monday, July 5th, 2021 - Friday, September 24th, 2021
- Holidays:
  - Civic Holiday - August 2nd, 2021
  - Labour Day - September 6th, 2021

### Link to Zoom Room

[Link to join the Zoom Room](https://generalassembly.zoom.us/j/98532953671?pwd=R2FYT0ladno5cklEbm94ZlZ4WmVoZz09)
...
| :--------- | :---------- | :----- | :--------------------------- |
| Instructor | David Bland | @David | david.bland@generalassemb.ly |
| Assistant Instructor| Dor Zairi | @Dor    | dorzairi@ymail.com   |
...
[Link to submit Deliverables - TBD next week]()
...
2. In another tab, browse to the GA class repo: [https://git.generalassemb.ly/sei-toronto/sei-42](https://git.generalassemb.ly/sei-toronto/sei-42)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/sei-42
```

You can now `$ cd sei-42` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/sei-toronto/sei-42.git
```
...
There are 30 highly recommended code challenges that will help you get the necessary practice of writing code, as well as teach you new methods and techniques.
